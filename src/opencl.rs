...
const PROGRAM_SOURCE: &str = include_str!("kernel/sha256.cl");

const KERNEL_NAME: &str = "hash_main";

pub fn init_opencl() -> Result<()> {
    ...
    println!("Found OpenCL device: {}", device.name().unwrap());
